...
| PM2 | Framing and remote control | WF2, R1 | [ ] |
...
| PM2.A | `change_intake` pack (WF2) | [ ] |
| PM2.B | Remote host transport + OpenCode loop (R1) | [ ] |
...
### PM2.B — Remote host transport (R1)
